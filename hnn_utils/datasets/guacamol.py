...
class GuacamolDataModule(L.LightningDataModule):
    ...
    def train_dataloader(self) -> DataLoader:
        ds = datasets.load_dataset(DS_PATH, split="train").select_columns("SELFIE")
    ...
    def val_dataloader(self) -> DataLoader:
        ds = datasets.load_dataset(DS_PATH, split="val").select_columns("SELFIE")
        transform = build_transform(self.vocab, self.randomize)
    ...
    def test_dataloader(self) -> DataLoader:
        ds = datasets.load_dataset(DS_PATH, split="test").select_columns("SELFIE")
        transform = build_transform(self.vocab, self.randomize)
